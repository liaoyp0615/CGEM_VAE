...
#SBATCH --output=/hpcfs/bes/mlgpu/liaoyp/jupyter/CGEM/2021code/VAE/Model/job/check_bvae.out
#SBATCH --error=/hpcfs/bes/mlgpu/liaoyp/jupyter/CGEM/2021code/VAE/Model/job/check_bvae.err
